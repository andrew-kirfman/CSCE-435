...
int main(int argc, char *argv[])
{
    ...
    MPI_Group sub_hypercube_group; 	// Group of all processes
    MPI_Group hypercube_group;		// Group of processes in dim-k hypercube
	...
	if (nbr_k > my_id) {
        ...
        // This call is just telling the neighbor how many elements we're sending!!    
